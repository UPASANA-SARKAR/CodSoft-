...
questions = ["What is the state flower of Haryana?","Which of the following state is NOT located in the North",
                 "In which of the following state, th main language is Khasi?","Which state has the largest area",
                 "What is the capital of Mizoram?"]
options = [['Lotus','Rhododendron','Golden Shower','Not declared','Lotus'],['Jharkhand','Jammu and Kashmir','Himachal Pradesh','Haryana','Jharkhand'],
               ['Mizoram','Nagaland','Meghalaya','Tripura','Meghalaya'],['Maharashtra','Madhya Pradesh','Uttar Pradesh','Rajasthan','Rajasthan'],
               ['Aizwal','Jaipur','Gangtok','Khawzawl','Aizwal']]
